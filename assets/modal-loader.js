  ...
  <div class="modal-content">
    ...
    <form class="contact-form" id="contact-form">
      ...
      <div class="form-row" style="margin-bottom:0">
        <div class="cf-turnstile" data-sitekey="0x4AAAAAAFEU3xvJ3CdoegSz" data-theme="dark"></div>
      </div>
      ...
      <div style="display:flex;gap:12px;flex-wrap:wrap;align-items:center;margin-top:16px">
        ...
        <a class="btn-ghost" href="mailto:labs@techpavitra.com">Or email directly</a>
      </div>
